...
export default function AuditPage() {
  ...
  async function loadControles(currentSocieteId: string) {
    try {
      const res = await fetch(
        `${API_URL}/societes/${currentSocieteId}/audit/resume`,
      );
        ...
        <header className="flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <p className="mt-0.5 text-sm text-zinc-500">
              Contrôles automatiques et alertes pour votre comptabilité.
            </p>
          </div>
          <div className="mt-2 flex flex-wrap gap-2 sm:mt-0">
            ...
            <button
              onClick={() => societeId && loadControles(societeId)}
        ...
        <section className="rounded-xl bg-white shadow-md">
          ...
          {controlesFiltres.length === 0 ? (
            <div className="p-12 text-center text-sm text-zinc-500">
              {controles.length === 0
                ? "Aucun contrôle détecté. Votre comptabilité est en ordre !"
                ...
                return (
                  ...
                  >
                    <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
                      ...
                      {controle.lien && (
                        <button
                          onClick={() => router.push(controle.lien!)}
