...
export default function TresoreriePage() {
  ...
  async function initData() {
    try {
      ...
      await Promise.all([loadRecettes(firstId), loadDepenses(firstId)]);
    } catch (err: any) {
        ...
        <header className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-500">
              Suivez vos encaissements (recettes) et décaissements (dépenses).
            </p>
          </div>
          <PeriodFilter
          ...
          <div className="rounded-xl bg-white p-4 shadow-sm">
            ...
            >
              ...
              <button
                type="submit"
                disabled={!societeId}
                className="w-full rounded-lg bg-emerald-600 px-4 py-2 text-sm font-medium text-white hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-70"
              >
                Ajouter la recette
              </button>
            </form>
          ...
          <div className="rounded-xl bg-white p-4 shadow-sm">
            ...
            >
              ...
              <button
                type="submit"
                disabled={!societeId}
                className="w-full rounded-lg bg-red-600 px-4 py-2 text-sm font-medium text-white hover:bg-red-700 disabled:cursor-not-allowed disabled:opacity-70"
              >
                Ajouter la dépense
              </button>
            </form>
