...
export default function FacturesPage() {
  ...
  async function loadFactures(currentSocieteId: string) {
    let url = `${API_URL}/societes/${currentSocieteId}/factures`;
  ...
  async function handleAddPaiement(e: React.FormEvent) {
    ...
    try {
      ...
      // Recharger l'historique et la liste des factures
        ...
        <header className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-zinc-500">
              Créez et consultez vos factures clients.
            </p>
          </div>
          <PeriodFilter
