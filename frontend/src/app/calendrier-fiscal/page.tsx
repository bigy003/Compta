...
export default function CalendrierFiscalPage() {
  ...
  async function initData() {
    try {
      ...
      await fetch(`${API_URL}/societes/${firstId}/echeances-fiscales/generer/${filters.annee}`, {
        method: "POST",
      });

      await loadEcheances(firstId);
    } catch (err: any) {
  ...
  async function loadEcheances(currentSocieteId: string) {
    try {
      ...
      const url = `${API_URL}/societes/${currentSocieteId}/echeances-fiscales?${params.toString()}`;
