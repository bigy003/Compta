...
export default function ExpertExercicesPage() {
  ...
  return (
    <div className="flex min-h-screen justify-center bg-zinc-50 px-4 py-10 font-sans">
      ...
      <main className="w-full max-w-5xl space-y-6">
        <header>
          <button
            onClick={() => router.push(`/expert/societes/${societeId}`)}
          ...
          <p className="text-sm text-zinc-500">
            Créez et gérez les exercices comptables annuels de cette société.
          </p>
        </header>
        ...
        <section className="rounded-xl bg-white p-4 shadow-sm">
          ...
          {loading ? (
            ...
            <p className="text-sm text-zinc-500">
              Aucun exercice créé. Créez le premier exercice pour commencer.
            </p>
          ) : (
