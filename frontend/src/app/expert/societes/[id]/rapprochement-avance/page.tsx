...
export default function ExpertRapprochementAvancePage() {
  ...
  async function loadCorrespondances() {
    try {
      ...
      const url = `${API_URL}/societes/${societeId}/rapprochement-avance/correspondances-automatiques${
  ...
  async function loadRapprochementsEnAttente() {
    try {
      const res = await fetch(
        `${API_URL}/societes/${societeId}/rapprochement-avance/en-attente`,
      );
  ...
  async function loadRapprochementsValides() {
    try {
      const res = await fetch(
        `${API_URL}/societes/${societeId}/rapprochement-avance?statut=VALIDATED`,
      );
      if (!res.ok) throw new Error("Erreur chargement rapprochements");
      const data = await res.json();
  ...
  async function initData() {
    try {
      ...
      await loadRapprochementsEnAttente();
      await loadRapprochementsValides();
    } catch (err: unknown) {
