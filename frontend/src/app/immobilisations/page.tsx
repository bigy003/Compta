...
export default function ImmobilisationsPage() {
  ...
  async function loadList(id: string) {
    const res = await fetch(`${API_URL}/societes/${id}/immobilisations`);
    ...
    <div className="min-h-screen bg-zinc-50 px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl space-y-6">
        <header>
          ...
          <p className="mt-0.5 text-sm text-zinc-500">Suivi des actifs et plans d&apos;amortissement (SYSCOHADA).</p>
        </header>
                      ...
                      <tr key={immo.id} className="hover:bg-zinc-50/50">
                        ...
                        <td className="px-4 py-3">
                          <div className="flex gap-2">
                            <button
                              type="button"
                              onClick={() => router.push(`/immobilisations/${immo.id}`)}
