...
export default function ImmobilisationDetailPage() {
  ...
  const immobilisationId = params.id;
  ...
  async function initData() {
    try {
      ...
      const res = await fetch(`${API_URL}/societes/${firstId}/immobilisations/${immobilisationId}`);
    ...
    return (
      <div className="min-h-screen bg-zinc-50 px-4 py-6 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          ...
          <button type="button" onClick={() => router.push("/immobilisations")} className="mt-4 text-sm font-medium text-zinc-600 hover:text-zinc-900">← Retour</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-zinc-50 px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl space-y-6">
        <header>
          <button type="button" onClick={() => router.push("/immobilisations")} className="mb-2 text-sm font-medium text-zinc-600 hover:text-zinc-900">← Retour Immobilisations</button>
